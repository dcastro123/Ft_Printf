...
/*   Updated: 2017/07/24 23:35:43 by dcastro-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	printf("'%04s", str);
	//ft_printf("'% 4.5i'\n", x);
	printf("1. real printf test with zero and prec < arg and prec > width:    '%04.5i'\n", x);
	printf("2. real printf test no zero and prec > arg and prec = width:      '%04.3i'\n", x);
	printf("3. real printf test no zero and prec > arg and prec < width:      '%7.4i'\n", x);
	printf("4. real printf test no zero and prec = arg and prec < width:      '%4.2i'\n", x);
	printf("5. real printf test no zero and prec < arg and prec < width:      '%4.1i'\n", x);
	...
	printf("9. real printf test with zero and prec = arg and prec > width and width < arg:    '%1.4i'\n", x);
	printf("------------------------------------------------------------------------\n");
	printf("------------------------------------------------------------------------\n");
	printf("------------------------------------------------------------------------\n");
	printf("------------------------------------------------------------------------\n");
